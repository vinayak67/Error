...
//	@DateTimeFormat(pattern="MM-dd-yyyy")
	...
	public CheckupRequest(int cid, String did, int serviceID, Date date) {
		super();
		this.cid = cid;
		this.did = did;
	...
	public CheckupRequest(int id, int cid, String did, int serviceID, Date date, String result, int d1_actual,
